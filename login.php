...
<?php
	...
	if($sub=="login"){
		...
		$res = $link->query("select * from login where username = '$us' and password='$pa'");
		...
		if($res->num_rows > 0)
		{
			...
			//echo "<script type='text/javascript'> alert('INAVALID USERNAME OR PASSWORD..PLEASE CHECK AGAIN'); </script>";
